...
* [**물류**](https://ysiksik.github.io/logistics/)
  * 총 8 개 프로젝트로 구성 위에 링크를 확인해 주세요

PAYPAL 및 STRIPE 기반의 **구독 결제 시스템** 을 도입하여 정기 결제를 지원했으며, 특히 STRIPE는 구매 전환율을 높이는 데 초점을 맞췄습니다. 또한, **알림 센터 및 선적 변경 알림 시스템** 을 구축해 실시간 물류 업데이트를 제공하고, **B2B 광고 플랫폼**을 개발하여 물류 업체 간 연결을 강화했습니다.
이와 함께, **FCL Schedule API** 및 **TERMINAL Schedule API** 를 통해 해운 일정을 자동으로 연동하여 운영 효율성을 높였으며, **FCL SCRAPER** 와 **TERMINAL SCRAPER** 를 개발해 선사 및 터미널 정보를 실시간으로 수집·정제하여 데이터의 정확성을 향상시켰습니다. 이를 통해 물류 산업의 디지털화를 가속화하고, 보다 체계적이고 효율적인 운영을 지원했습니다.

* [**결제 시스템 (PG)**](https://ysiksik.github.io/payment-system/)
  * 총 15 개 프로젝트로 구성 위에 링크를 확인해 주세요

전자 상거래, 모바일 앱, POS(Point of Sale) 환경에서 다양한 결제 수단(신용카드, 계좌이체 등)을 안전하고 신속하게 처리하는 결제 시스템을 구축했습니다. 결제 API 개발, 원천사 연동, 인증 시스템 구현 등을 통해 안정적인 트랜잭션 환경을 제공합니다. 또한, PG(결제 대행사)별 차액 정산 및 대사(정산 내역 검증) 처리를 자동화하기 위해 배치 시스템을 개발하여 데이터 정합성을 보장하고, PG별 대사 파일을 다운로드·저장하는 기능을 구현했습니다. 가맹점 및 대리점 API를 개발하여 결제 연동을 최적화하고, 멀티 모듈 프로젝트 구조를 도입하여 유지보수성을 강화했습니다.

* [**쿠폰 서비스**](https://ysiksik.github.io/coupon-service/)
  * 총 5 개 프로젝트로 구성 위에 링크를 확인해 주세요

사용자가 모바일을 통해 간편하게 쿠폰을 발급·사용할 수 있도록 하는 소액 결제 기반의 쿠폰 서비스입니다. 할인 적용, 프로모션 관리, 쿠폰 복원 및 취소 기능을 포함하며, 다양한 결제 시스템과 연동하여 원활한 사용자 경험을 제공합니다.

* [**비트코인 거래소**](https://ysiksik.github.io/coin-exchange/)

비트코인 및 암호화폐 거래를 위한 웹 기반 거래소를 개발했습니다. 사용자는 이 플랫폼을 통해 안전하게 암호화폐를 구매·판매할 수 있으며, 실시간 거래 기능, 지갑 연동, 보안 강화된 결제 프로세스를 통해 원활한 거래 환경을 제공합니다.
