...
결제 시스템(PG, Payment Gateway)은 전자 상거래, 모바일 앱, POS(Point of Sale) 등에서 신용카드, 계좌이체 등 다양한 결제 수단을 통해 안전하고 신속하게 결제를 처리하는 시스템입니다.

* [**쿠폰 서비스** 2019.08 ~ 2021.04](https://ysiksik.github.io/coupon-service/)
  * 총 5 개 프로젝트로 구성 위에 링크를 확인해 주세요

휴대폰 소액 결제 쿠폰 서비스는 사용자가 휴대폰을 통해 간편하게 소액 결제를 할 수 있도록 지원하는 서비스입니다. 이 서비스를 통해 사용자는 원하는 상품을 구매할 때 쿠폰을 활용하여 할인 혜택을 받거나 쿠폰을 발급받을 수 있습니다.

* [**비트코인 거래소** 2018.03 ~ 2019.08](https://ysiksik.github.io/coin-exchange/)

이 프로젝트는 비트코인 거래소 웹 애플리케이션을 개발하는 것을 목표로 합니다. 사용자는 이 애플리케이션을 통해 비트코인을 쉽고 안전하게 구매하거나 판매할 수 있습니다. 거래소는 비트코인 거래를 중개하는 역할을 하며, 원활한 거래 환경을 제공합니다.
