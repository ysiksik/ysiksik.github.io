...
* [**결제 시스템 (PG)** 2021.04 ~ 진행 중](https://ysiksik.github.io/payment-system/)
  * 총 15 개 프로젝트로 구성 위에 링크를 확인해 주세요

결제 시스템(PG)은 전자 상거래, 모바일 앱, POS 등에서 신용카드나 계좌이체 등 다양한 결제 수단을 통해 결제를 처리하는 시스템입니다

* [**쿠폰 서비스** 2019.08 ~ 2021.04](https://ysiksik.github.io/coupon-service/)
  * 총 5 개 프로젝트로 구성 위에 링크를 확인해 주세요

휴대폰 소액 결제 쿠폰 서비스는 사용자들이 휴대폰을 통해 간편하게 소액 결제를 할 수 있도록 도와주는 서비스입니다. 이 서비스는 사용자들이 원하는 상품을 구매할 때 쿠폰을 사용하여 할인 또는 쿠폰 발급을 받을 수 있는 기능을 제공합니다
...
| -- | -- | -- | -- |
| 2021.04 ~ 재직 중 | 립페이 | PG 개발팀 / 대리  | 립페이는 결제 서비스(PG) 시스템 개발을 주로 담당하였습니다. 대리점, 가맹점, 결제를 위한 API를 개발하고 다양한 원천사와 연동하여 안정적인 결제 시스템을 구축하였습니다. 인증 결제, BATCH, 관리자 페이지 등 다양한 프로젝트를 수행하였으며, 이를 통해 효율적인 개발 프로세스와 팀워크를 경험했습니다. |
