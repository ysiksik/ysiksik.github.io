...
+ 싱글톤 빈 요청
  + ![img.png](../../../../assets/img/spring-core-basics/BeanScope.png)
  1. 싱글톤 스코프의 빈을 스프링 컨테이너에 요청한다
  2. 스프링 컨테이너는 본인이 관리하는 스프링 빈을 반환한다
  3. 이후에 스프링 컨테이너에 같은 요청이 와도 같은 객체 인스턴스의 스프링 빈을 반환한다

+ 프로토타입 빈 요청1
  + ![img_1.png](../../../../assets/img/spring-core-basics/BeanScope1.png)
  1. 프로토타입 스코프의 빈을 스프링 컨테이너에 요청한다.
  2. 스프링 컨테이너는 이 시점에 프로토타입 빈을 생성하고, 필요한 의존관계를 주입한다

+ 프로토타입 빈 요청2
  + ![img_2.png](../../../../assets/img/spring-core-basics/BeanScope2.png)
...
+ 스프링 컨테이너에 프로토타입 빈 직접 요청1
  + ![img_3.png](../../../../assets/img/spring-core-basics/BeanScope3.png)
...
+ 스프링 컨테이너에 프로토타입 빈 직접 요청2
  + ![img_4.png](../../../../assets/img/spring-core-basics/BeanScope4.png)
...
+ 싱글톤에서 프로토타입 빈 사용1
  + ![img_5.png](../../../../assets/img/spring-core-basics/BeanScope5.png)
...
+ 싱글톤에서 프로토타입 빈 사용2
  + ![img_6.png](../../../../assets/img/spring-core-basics/BeanScope6.png)
...
+ 싱글톤에서 프로토타입 빈 사용3
  + ![img_7.png](../../../../assets/img/spring-core-basics/BeanScope7.png)
...
> 여러 빈에서 같은 프로토타입 빈을 주입 받으면, 주입 받는 시점에 각각 새로운 프로토타입 빈이
...
### JSR-330 Provider
javax.inject.Provider 라는 JSR-330 자바 표준을 사용하는 방법이다 이 방법을 사용하려면 javax.inject:javax.inject:1 라이브러리를 gradle에 추가해야 한다
...
+ HTTP request 요청 당 각각 할당되는 request 스코프
  + ![img_8.png](../../../../assets/img/spring-core-basics/BeanScope8.png)
...
+ ![img_9.png](../../../../assets/img/spring-core-basics/BeanScope9.png)
