...
+ ![KubernetesArchitecture.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/KubernetesArchitecture.png)
  + k8s 는 하나의 Master 와 다수의 Worker Node 들로 구성 된다.
+ ![KubernetesArchitecture_1.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/KubernetesArchitecture_1.png)
...
+ ![KubernetesArchitecture_2.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/KubernetesArchitecture_2.png)
...
+ ![KubernetesArchitecture_3.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/KubernetesArchitecture_3.png)
...
+ ![KubernetesArchitecture_4.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/KubernetesArchitecture_4.png)
...
+ ![Storage-NFS-Longhorn.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager.png)
  + Master Node 에는 Etcd, kube-scheduler, kube-apiserver 가 있다. 일반적인 설치를 했을 때 이 Component 들은 Pod 형태로 띄워져서 구동 된다.
+ ![Networking1.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager1.png)
...
+ ![Networking2.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager2.png)
  + Worker Node 들은 k8s 를 설치할 때 같이 설치한 kubelet 과 Container Runtime 인 Docker 가 구동중인 상태이다.
+ ![Networking3.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager3.png)
...
+ ![Networking4.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager4.png)
...
+ ![Networking5.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager5.png)
...
+ ![Networking6.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager6.png)
...
+ ![Networking7.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager7.png)
...
+ ![Networking8.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager8.png)
...
+ ![Networking9.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager9.png)
...
+ ![Networking10.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager10.png)
...
+ ![Networking11.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager11.png)
  + 이 상황에서 kube-scheduler 는 Node 가 할당 되지 않은 Pod 를 감지하고, 현재 Node 들의 자원을 고려해서 Pod 들에게 Scheduling 된 Node 를 할당 해준다.
+ ![Networking12.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Component-kube-apiserver-etcd-kube-schedule-kube-proxy-kube-controller-manager12.png)
...
+ ![Networking4.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking4.png)
...
+ ![Networking5.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking5.png)
  + Network Plugin 의 역할은 같은 Node 간의 통신과 외부 네트워크를 통한 타 Node 위에 있는 Pod 간 통신을 담당 한다.
+ ![Networking6.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking6.png)
...
+ ![Networking7.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking7.png)
...
+ ![Networking8.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking8.png)
...
+ ![Networking9.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking9.png)
...
+ ![Networking10.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking10.png)
...
+ ![Networking11.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking11.png)
  + Pod 를 생성하면 새로운 네트워크 인터페이스를 만드는데, Pod 의 인터페이스와 Host Network 의 가상인터페이스가 연결 된다.
+ ![Networking12.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking12.png)
...
+ ![Networking13.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking13.png)
...
+ ![Networking14.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking14.png)
...
+ ![Networking15.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking15.png)
...
+ ![Networking16.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking16.png)
...
+ ![Networking17.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking17.png)
  + Calico 는 이 Pod 의 ip 대역이 어느 Node 에 있는지 알고 있기 때문에, 패킷에 실제 Pod 의 ip 를 해당 Node 의 ip 로 감싼다.
+ ![Networking18.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking18.png)
...
+ ![Networking19.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking19.png)
...
+ ![Networking20.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking20.png)
...
+ ![Networking21.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking21.png)
...
+ ![Networking22.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking22.png)
...
+ ![Networking23.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking23.png)
  + Calico 의 Pod Network 구조.
+ ![Networking24.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking24.png)
  + Router 부분에서 Service ip 를 Pod ip 로 변환 해주는 NAT 역할을 하는 기능이 있다.
+ ![Networking25.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking25.png)
...
+ ![Networking26.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking26.png)
...
+ ![Networking27.png](../../../../assets/Storage-NFS-Longhorn/kubernetes-trending/Networking27.png)
